...
2/ writeParking.py writes parking availability of car parks to database.

3/ writeVMS.py writes message board messages to database.
...
improve (1). Now it is written in a very inefficient way (for loop; because I failed to disentangle to nested json file).
